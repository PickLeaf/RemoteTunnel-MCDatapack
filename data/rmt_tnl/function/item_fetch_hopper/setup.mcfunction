...
execute unless block ^ ^1 ^-1 minecraft:amethyst_block \
    run return run \
        data remove storage rmt_tnl:var stop
execute unless block ^ ^2 ^-1 minecraft:decorated_pot \
    run return run \
        data remove storage rmt_tnl:var stop
